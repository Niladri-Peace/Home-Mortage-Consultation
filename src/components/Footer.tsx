...
export default function Footer() {
  ...
  const footerLinks = [
    ...
    },
    {
      title: 'Products',
      links: [
        { name: 'Mortgages', href: '/start' },
        { name: 'Refinance', href: '/start?type=refinance' },
          ...
          <div className="space-y-8 xl:col-span-1">
            ...
            ">
              {socialLinks.map((item) => (
                <Link key={item.name} href={item.href} className="text-gray-400 hover:text-green-600 transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="md:flex md:items-center md:justify-between">
            <p className="text-base text-gray-500 text-center md:text-left">
              &copy; {currentYear} Better.com. All rights reserved.
            </p>
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            <p>Better is a wholly owned subsidiary of Better Holdco, Inc. NMLS ID #330511. Not available in all states.</p>
            <p className="mt-2">© Better Holdco, Inc. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
